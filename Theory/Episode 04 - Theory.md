...
virtual Dom is a representation of the browser DOM. It is a lightweight copy of the real DOM that exists in memory. React uses this virtual DOM to efficiently update the real DOM when necessary.
